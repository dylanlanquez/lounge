...
import { LEDGER_EXTRA_PRESETS, type DateRange } from '../lib/dateRange.ts';
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: theme.space[2] }}>
      ...
      >
        ...
        <DateRangePicker
          ...
          size="sm"
          // Ledger-specific shortcuts. "Upcoming" / "Past" used to be
          // standalone pills next to this picker; folding them in here
          // gives the receptionist one place to pick a date frame
          // instead of two parallel widgets to think about.
          extraPresets={LEDGER_EXTRA_PRESETS}
        />
        {filtersActive ? (
          <button
            type="button"
...
// Upcoming / Past used to live as standalone toggles next to the date
// picker. They now ship as injected presets inside the picker itself
