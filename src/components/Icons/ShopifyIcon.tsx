// Shopify brand mark. Lifted verbatim from the asset Dylan provided
// — three-colour fill (lime body / forest base / white S) is the
// official Shopify bag, so it shouldn't be retinted; the `title`
// prop is the only knob, exposed for screen readers when rendered
// without a co-located label.
...
export function ShopifyIcon({ size = 20, title }: ShopifyIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 108.44 122.88"
      width={size}
      height={(size * 122.88) / 108.44}
