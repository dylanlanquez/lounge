...
//
// Customer-facing copy of the staff app's DepositGlyph — 12
// organic-sized dots forming a dashed ring. Path data mirrors
// src/components/DepositGlyph/DepositGlyph.tsx; duplicated inside
// the widget bundle so the embed stays self-contained and doesn't
// drag @components from the staff side into widget output. If the
// path data ever changes there, change it here too.
