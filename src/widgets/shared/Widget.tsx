...
function DepositGlyph({ size = 20 }: { size?: number }) {
  // Custom arrow-around-percentage mark Dylan supplied for the
  // deposit indicator on the footer. Inlined here rather than
  // imported as a file so the widget bundle stays single-asset
  // (no extra HTTP request) and the icon picks up `currentColor`
  // from the parent FooterPriceBlock without theming plumbing.
  return (
    <svg
      width={size}
      height={size}
      viewBox="0 0 386.99 355.2"
      fill="currentColor"
      aria-hidden
      style={{ display: 'block', flexShrink: 0 }}
    >
      <path d="M0,186.51v-3.61c.28.12,1.03-2.88,1.49-3.69l32.81-32.84c4.39-4.4,10.4-4.45,14.62-.22l31.67,31.76c3.86,3.87,3.3,10.34-.38,13.63s-9.39,3.6-13.12-.09l-15.78-15.59c-.75,41.73,15.49,81.13,43.62,110.81,46.15,48.7,118.02,63.16,179.26,35.6,36.08-16.23,64.83-45.18,80.81-81.66,17.61-40.17,17.49-86.41-.21-126.48-22.07-49.95-68.39-85.55-122.41-93.27-50.35-7.2-100.54,9.69-135.9,45.96-3.83,3.92-9.95,3.79-13.4.7-4.08-3.65-4.29-9.93-.51-13.84,69.9-72.34,186.99-71.46,256.35,2.16,28.64,30.4,45.65,69.56,48.06,111.31v20.9c-2.05,35.57-14.58,68.91-35.54,96.64-63.61,84.14-186.24,94.67-263.11,22.51-36-33.8-56.59-80.61-56.22-131.44l-15.98,15.76c-2.63,2.59-6.57,3.2-10.2,1.93-2.74-.96-4.65-3.71-5.93-6.92Z" />
      <path d="M156.77,243.72c-4.16,4.16-10.11,3.55-13.71.11-3.29-3.13-4.01-9.49-.06-13.44l117.84-117.77c3.65-3.65,9.88-2.84,13.03.19s4.33,9.46.48,13.31l-117.58,117.59Z" />
      <path d="M164.14,104.62c19.47-.9,34.85,14.29,35.68,32.58.85,18.89-13.86,34.72-32.44,35.65-18.73.93-34.69-13.47-35.77-32.01-1.1-18.74,12.98-35.32,32.53-36.22ZM161.84,124.24c-8.63,2.22-12.67,10.83-10.66,18.41,2.16,8.16,10.44,12.64,18.44,10.59s12.56-10.11,10.69-18.03c-1.86-7.87-9.87-13.17-18.47-10.96Z" />
      <path d="M248.09,182.64c19.18-3.39,36.29,9.59,39.48,27.78s-9.23,36.11-27.43,39.37c-18.48,3.31-36.01-8.69-39.6-26.87-3.65-18.5,8.15-36.86,27.54-40.28ZM251.86,201.43c-9.01,1.32-14.3,9.48-12.63,17.85,1.53,7.68,8.94,13.16,17.23,11.79,7.82-1.29,13.62-8.71,12.4-17.01-1.14-7.73-8.28-13.9-17-12.63Z" />
    </svg>
  );
}
