// Email-safe icon SVG data extracted from lucide-react@0.469.0.
// All icons use a 24×24 viewBox, stroke-based (no fill).
// Used by the SnippetEditor button dialog and email renderers.
...
export const EMAIL_ICONS: Record<string, string> = {
  ...
  CalendarHeart: '<path d="M3 10h18V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h7"/><path d="M8 2v4"/><path d="M16 2v4"/><path d="M21.29 14.7a2.43 2.43 0 0 0-2.65-.52c-.3.12-.57.3-.8.53l-.34.34-.35-.34a2.43 2.43 0 0 0-2.65-.53c-.3.12-.56.3-.79.53-.95.94-1 2.53.2 3.74L17.5 22l3.6-3.55c1.2-1.21 1.14-2.8.19-3.74Z"/>',
...
export const EMAIL_ICON_LIST: Array<{ name: string; label: string }> = [
  ...
  { name: 'CalendarCheck', label: 'Cal. check'  },
  { name: 'CalendarDays', label: 'Cal. days'    },
  { name: 'CalendarClock', label: 'Cal. clock'  },
  { name: 'CalendarPlus', label: 'Cal. plus'    },
  { name: 'CalendarX',    label: 'Cal. cancel'  },
  { name: 'CalendarHeart', label: 'Cal. heart'  },
  { name: 'Clock',        label: 'Clock'        },
  { name: 'AlarmClock',   label: 'Alarm'        },
  { name: 'Video',        label: 'Video call'   },
  { name: 'Phone',        label: 'Phone'        },
  { name: 'Mail',         label: 'Mail'         },
  { name: 'MailOpen',     label: 'Mail open'    },
  { name: 'MapPin',       label: 'Location'     },
  { name: 'CircleCheck',  label: 'Confirmed'    },
  { name: 'Check',        label: 'Tick'         },
  { name: 'ArrowRight',   label: 'Arrow right'  },
  { name: 'ExternalLink', label: 'Ext. link'    },
...
export function iconSvg(name: string, strokeColor: string, size = 16): string {
  const inner = EMAIL_ICONS[name];
  if (!inner) return '';
