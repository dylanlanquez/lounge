...
const APPOINTMENT_VARIABLES: ReadonlyArray<EmailTemplateVariable> = [
  ...
  },
  {
    ...
    label: 'Estimated appointment timeline',
    description:
      "Email-safe twin of the Estimated-appointment-length popup that lives on the staff-side VisitDetail / AppointmentDetail page. Renders the materialised phases as a vertical timeline (time column on the left, accent rail with dots + connectors in the middle, icon pill + heading + sub-line on the right) and a trailing Estimated finish row. Empty for any booking whose row has no materialised phases on file (legacy bookings pre-dating the materialiser).",
    // Sample HTML lifted from the actual edge-function output for a
    // representative virtual_impression_appointment so the admin
    // preview is a faithful render of what the patient will see.
    // parseFormatting's raw-HTML rule passes leading <table>
    // through verbatim.
    sample:
      '<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="border-collapse:collapse;margin:0 0 16px 0;"><tr><td valign="top" style="width:64px;padding:1px 16px 0 0;text-align:right;font-variant-numeric:tabular-nums;font-size:13px;font-weight:600;color:#0E1414;letter-spacing:-0.005em;line-height:1.2;">14:00</td><td valign="top" style="width:14px;padding:0;"><div style="width:14px;padding-top:4px;text-align:center;line-height:0;"><div style="display:inline-block;width:12px;height:12px;border-radius:50%;background:#0D9488;border:2px solid #0D9488;box-sizing:border-box;"></div></div></td><td valign="top" style="padding:0 0 12px 16px;"><table role="presentation" cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse;"><tr><td valign="middle" style="padding:0 8px 0 0;"><span style="display:inline-block;width:26px;height:26px;line-height:26px;border-radius:999px;background:#0D9488;text-align:center;vertical-align:middle;"><img src="https://npuvhxakffxqoszytkxw.supabase.co/storage/v1/object/public/lng-email-assets/User-white.png" width="14" height="14" alt="" style="vertical-align:middle;display:inline-block;border:0;"/></span></td><td valign="middle" style="padding:0;"><span style="font-size:15px;font-weight:600;color:#0E1414;letter-spacing:-0.005em;line-height:1.25;">Greet and seat</span></td></tr><tr><td></td><td style="padding:4px 0 0 0;font-size:13px;color:#4A5159;line-height:1.4;"><span style="font-weight:500;">10 min</span><span style="display:inline-block;width:3px;height:3px;border-radius:50%;background:#9CA3A3;margin:0 8px;vertical-align:middle;"></span><span>You\'re with us</span></td></tr></table></td></tr><tr><td style="width:64px;padding:0;"></td><td style="width:14px;padding:0;"><div style="width:14px;height:32px;text-align:center;line-height:0;"><div style="display:inline-block;width:2px;height:32px;border-left:2px solid #0D9488;opacity:0.4;"></div></div></td><td style="padding:0;"></td></tr><tr><td valign="top" style="width:64px;padding:1px 16px 0 0;text-align:right;font-variant-numeric:tabular-nums;font-size:13px;font-weight:600;color:#0E1414;letter-spacing:-0.005em;line-height:1.2;">14:10</td><td valign="top" style="width:14px;padding:0;"><div style="width:14px;padding-top:4px;text-align:center;line-height:0;"><div style="display:inline-block;width:12px;height:12px;border-radius:50%;background:#FFFFFF;border:2px solid #0D9488;box-sizing:border-box;"></div></div></td><td valign="top" style="padding:0 0 12px 16px;"><table role="presentation" cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse;"><tr><td valign="middle" style="padding:0 8px 0 0;"><span style="display:inline-block;width:26px;height:26px;line-height:26px;border-radius:999px;background:#E6F4F1;text-align:center;vertical-align:middle;"><img src="https://npuvhxakffxqoszytkxw.supabase.co/storage/v1/object/public/lng-email-assets/Hourglass-accent.png" width="14" height="14" alt="" style="vertical-align:middle;display:inline-block;border:0;"/></span></td><td valign="middle" style="padding:0;"><span style="font-size:15px;font-weight:600;color:#0E1414;letter-spacing:-0.005em;line-height:1.25;">Take impressions</span></td></tr><tr><td></td><td style="padding:4px 0 0 0;font-size:13px;color:#4A5159;line-height:1.4;"><span style="font-weight:500;">20 min</span><span style="display:inline-block;width:3px;height:3px;border-radius:50%;background:#9CA3A3;margin:0 8px;vertical-align:middle;"></span><span>Step away, back at 14:30</span></td></tr></table></td></tr><tr><td style="width:64px;padding:0;"></td><td style="width:14px;padding:0;"><div style="width:14px;height:32px;text-align:center;line-height:0;"><div style="display:inline-block;width:2px;height:32px;border-left:2px dashed #0D9488;opacity:0.4;"></div></div></td><td style="padding:0;"></td></tr><tr><td valign="top" style="width:64px;padding:1px 16px 0 0;text-align:right;font-variant-numeric:tabular-nums;font-size:13px;font-weight:600;color:#0E1414;letter-spacing:-0.005em;line-height:1.2;">~14:30</td><td valign="top" style="width:14px;padding:0;"><div style="width:14px;padding-top:4px;text-align:center;line-height:0;"><div style="display:inline-block;width:12px;height:12px;border-radius:50%;background:#FFFFFF;border:2px solid #0D9488;box-sizing:border-box;"></div></div></td><td valign="top" style="padding:0 0 0 16px;"><table role="presentation" cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse;"><tr><td valign="middle" style="padding:0 8px 0 0;"><span style="display:inline-block;width:26px;height:26px;line-height:26px;border-radius:999px;background:#E6F4F1;text-align:center;vertical-align:middle;"><img src="https://npuvhxakffxqoszytkxw.supabase.co/storage/v1/object/public/lng-email-assets/Flag-accent.png" width="14" height="14" alt="" style="vertical-align:middle;display:inline-block;border:0;"/></span></td><td valign="middle" style="padding:0;"><span style="font-size:15px;font-weight:600;color:#0E1414;letter-spacing:-0.005em;line-height:1.25;">Estimated finish</span></td></tr><tr><td></td><td style="padding:4px 0 0 0;font-size:13px;color:#4A5159;line-height:1.4;">You\'re free to go</td></tr></table></td></tr></table>',
  },
  {
