...
export const MARKETING_WALKTHROUGH: WalkthroughTour = {
  ...
  steps: [
    ...
    },
    {
      ...
      body: "Once a patient is marked as arrived, open their visit. Use Before & after for the before and after shots, and Marketing content for the finished result, the branded bag, and the new smile. Every one of these is content we can use.",
    ...
    },
    {
      ...
      body: "Both your before and afters and your marketing photos gather in Marketing content up top, and on the patient’s profile, ready for the team to post any time. That is everything, thank you for helping us build our content.",
      route: '/marketing/demo',
    },
  ],
};
